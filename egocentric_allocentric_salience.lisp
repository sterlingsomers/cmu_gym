...
(define-model test-blending
    (sgp :sim-hook "similarity_function"
         ...
         :tmp 0.85        ;:seed (1 1) :bll nil :blc 5 :mp 1 :v t :blt t :esc t :ans .25 :rt -5)
         :seed (1 1) :bll nil :blc 5 :mp 4 :v nil :blt nil :esc t :ans nil :rt -5000 :lf 0 :ncnar nil :value->mag second)
  ...
  (chunk-type observation hiker_left hiker_diagonal_left hiker_center hiker_diagonal_right hiker_right
              ego_left ego_diagonal_left ego_center ego_diagonal_right ego_right altitude distance_to_hiker fc)
