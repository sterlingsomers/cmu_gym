...
(define-model test-blending
    (sgp :sim-hook "similarity_function"
         ...
         :tmp 1  ;temperature      ;:seed (1 1) :bll nil :blc 5 :mp 1 :v t :blt t :esc t :ans .25 :rt -5)
         ;:seed (1 1) ;random  seed
         :ans nil ;activation nose
         :rt -5000 ;retrieval threshold
          :bll nil :blc 5 :mp 3 :v nil :blt nil :esc t :lf 0 :ncnar nil :value->mag second)
