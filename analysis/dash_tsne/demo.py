...
from analysis.generate_image_state_from_saved_data import generate_observation as gen_ob
        ...
        if dataset in IMAGE_DATASETS and clickData:
            ...
            if bool_mask_click.any():
                ...
                if dataset == "cifar_gray_3000":
                    ...
                    image_np = image_vector.reshape(16, 16).astype(np.float64)
        ...
        if dataset in IMAGE_DATASETS and clickData:
            ...
            if bool_mask_click.any():
                ...
                return html.Img(
                    ...
                    style={"height": "62vh", "display": "block", "margin": "auto"}, # 40vh becomes a lot bigger
                )
        return None
