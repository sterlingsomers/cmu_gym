...
actr.load_act_r_model("/Users/paulsomers/COGLE/gym-gridworld/drop-prototype_test.lisp")
...
chks.append(['isa', 'decision', 'one', ['one',1], 'two', ['two',0],'delta_x',['delta_x',1],'delta_y',['delta_y',0]])#,'three', ['three',1],
...
chks.append(['isa','decision', 'one', ['one',0], 'two', ['two',1],'delta_x',['delta_x',0],'delta_y',['delta_y',1]])#, 'three', ['three',2],
...
chks.append(['isa','decision','one',['one',1],'two',['two',1],'delta_x',['delta_x',1],'delta_y',['delta_y',1]])#,'three',['three',2],
             #'four',['four',1],'five',['five',1],'six',['six',1],
...
chks.append(['isa', 'decision','one',['one',0],'two',['two',0],'delta_x',['delta_x',0],'delta_y',['delta_y',0]])#,'three',['three',1],
             #'four',['four',2],'five',['five',1],'six',['six',1],
            # 'seven',['seven',2],'eight',['eight',1],'nine',['nine',1],
             #'delta_x',['delta_x',-1],'delta_y',['delta_y',0]])
...
#Probe
chk = ['isa', 'observation', 'one', ['one',0], 'two', ['two',1],'actual_x',['actual_x',0],'actual_y',['actual_y',1]]#,'three', ['three',1],
             #'four', ['four',1], 'five', ['five',1], 'six', ['six',1],
             #'seven', ['seven',2], 'eight', ['eight',2], 'nine', ['nine',2],'actual_x',['actual_x',0],'actual_y',['actual_y',1]]
