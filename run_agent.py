...
flags.DEFINE_string("model_name", "Drop_random_map_extra_step_correction", "Name for checkpoints and tensorboard summaries")
...
def main():
    ...
    if FLAGS.training:
        ...
        try:
            ...
            with open('./data/custom_map_static.tj', 'wb') as handle:
