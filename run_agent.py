...
flags.DEFINE_string("model_name", "Drop_rand_positive_reward_reducedsteppenalty_distancereward_edgefix_terrain", "Name for checkpoints and tensorboard summaries")
