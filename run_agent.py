...
flags.DEFINE_integer("n_envs", 4, "Number of environments to run in parallel")
...
flags.DEFINE_string("model_name", "Testing", "Name for checkpoints and tensorboard summaries")
