...
flags.DEFINE_string("model_name", "Drop_map", "Name for checkpoints and tensorboard summaries")
flags.DEFINE_integer("K_batches", 4000,
...
def main():
    ...
    else: # Testing and debugging here (switch to your local Python interpreter.
