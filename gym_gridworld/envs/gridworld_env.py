...
class GridworldEnv(gym.Env):
    ...
    def reset(self):
        ...
        start = random.choice([2,2,2,2,2,2,2,1,1,1])
        stop = random.choice([2,2,2,2,2,2,2,4,4,4])
        ...
        drone = (random.randint(hiker[0]-1,hiker[0]+1),hiker[1]-1,hiker[1]+1)#random.choice([(hiker[0]-1, hiker[1]-1),(hiker[0]-1, hiker[1]),(hiker[0], hiker[1]-1)])## Package drop starts close to hiker!!! #(random.randint(2, self.map_volume['vol'].shape[1] - 1), random.randint(2, self.map_volume['vol'].shape[1] - 2)) # (8,8) #
        #else:
            # hiker = (random.randint(2, self.map_volume['vol'].shape[1] - 2), random.randint(2, self.map_volume['vol'].shape[1] - 2))  # (7,8) #
