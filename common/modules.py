...
def multihead_attention(queries,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        outputs = feedforward(outputs, num_units=[256, 66], trainable=trainable) # contains residual + normalization, 4* is as a rules of thumbs for first layer to be 4 times inputs size
...
def feedforward(inputs,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        params = {"inputs": outputs, "filters": num_units[1], "kernel_size": 1,
                  "activation": None, "use_bias": True, "trainable": trainable} # put relu here, might
