...
'''This model uses egocentric data and an allocentric representatino of the drone's location. '''
...
def reset_actr():
    ...
    model_path = '/Users/paulsomers/COGLE/gym_gridworld/'
...
reset_actr()
start = time.time()
resultl = handle_observation(['isa','observation',
                    'current_altitude',['current_altitude',1],
                    #'heading',['heading',5],
                    'view_left',['view_left',-1],
                    'view_diagonal_left',['view_diagonal_left',0],
                    'view_center',['view_center',0],
                    'view_diagonal_right',['view_diagonal_right',-1],
